...
import { useCreateFacultyEvent, useUpdateFacultyEvent, useDeleteFacultyEvent } from "@/hooks/use-mutations";
    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Manage events for your club</p>
        </div>
